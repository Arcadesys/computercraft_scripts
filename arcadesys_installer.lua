...
-- Auto-generated at 2025-11-24T20:32:17.686Z
print("Starting Arcadesys install...")
local files = {}

files["arcade/arcade_shell.lua"] = [[if not string.find(package.path, "/lib/?.lua") then
...
return programs]]
files["arcade/games/store.lua"] = [[local arcade = require("arcade")
local programs = require("data.programs")
...
files["arcade/games/themes.lua"] = [[local arcade = require("arcade")
...
files["arcade/factory_planner.lua"] = [[print("Loading Factory Planner v2.0...")
sleep(1)
local blockList = {}
...
files["arcade/farm_manager.lua"] = [[local strategyFarm = require("lib.lib_strategy_farm")
