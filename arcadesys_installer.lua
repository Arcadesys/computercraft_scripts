...
files["arcade/arcade_shell.lua"] = [[---@diagnostic disable: undefined-global
-- arcade_shell.lua
...
files["arcade/arcade.lua"] = [[-- arcade.lua
...
files["arcade/arcadeos.lua"] = [=[-- ArcadeOS Installer
...
files["arcade/games/arcade.lua"] = [[---@diagnostic disable: undefined-global
-- Shim so games written for `games/arcade.lua` can require the shared adapter
-- even when the files are placed at the repository root.
return require("arcade")
]]
files["arcade/games/artillery.lua"] = [[-- artillery.lua
-- A 2-player artillery game using Pine3D
...
gameLoop()]]
files["arcade/games/blackjack.lua"] = [[---@diagnostic disable: undefined-global, undefined-field
-- Blackjack arcade game
-- Uses the shared three-button arcade wrapper. Implements a multi-deck shoe,
-- betting controls, and the usual hit/stand/double play flow.
-- Lua tip: using small helper functions (like card builders and draw helpers)
...
files["arcade/games/cantstop.lua"] = [[-- Can't Stop (Sid Sackson) on ComputerCraft
-- Author: You + Copilot
-- 
-- This script implements a playable version of "Can't Stop" with:
-- - A monitor UI using a persistent three-button bar at the bottom
...
files["arcade/games/idlecraft.lua"] = [[---@diagnostic disable: undefined-global, undefined-field
-- IdleCraft (Arcade wrapper version)
-- Refactored to run inside the generic three‑button arcade framework in `games/arcade.lua`.
-- The original standalone event / layout system has been removed. All rendering now
-- happens inside a single playfield using arcade's helper methods.
...
-- END OF FILE]]
files["arcade/games/poker.lua"] = [[---@diagnostic disable: undefined-global, undefined-field
...
files["arcade/games/slots.lua"] = [[---@diagnostic disable: undefined-global, undefined-field
-- Slots with animated reels and weighted symbols
-- Uses the shared arcade wrapper (games/arcade.lua) for a monitor UI and credits.
-- Features: weighted virtual reels, animated spin frames in onTick, adjustable bet,
-- multi-line slot window with colored icons, and win flashes/sounds when possible.
...
files["arcade/license_store.lua"] = [[---@diagnostic disable: undefined-global
-- license_store.lua
-- Simple disk-backed license manager for arcade programs.
-- Uses lightweight signatures to discourage casual tampering of license files.
...
files["arcade/models/projectile.lua"] = [[---@diagnostic disable: undefined-global
local function newPoly(x1, y1, z1, x2, y2, z2, x3, y3, z3, c)
  return {
    x1 = x1, y1 = y1, z1 = z1, x2 = x2, y2 = y2, z2 = z2, x3 = x3, y3 = y3, z3 = z3,
    c = c,
...
return proj]]
files["arcade/models/tank.lua"] = [[---@diagnostic disable: undefined-global
local function newPoly(x1, y1, z1, x2, y2, z2, x3, y3, z3, c)
  return {
    x1 = x1, y1 = y1, z1 = z1, x2 = x2, y2 = y2, z2 = z2, x3 = x3, y3 = y3, z3 = z3,
    c = c,
...
files["factory/harness_common.lua"] = [[-- Shared utilities for harness_* scripts.
...
files["factory/harness_fuel.lua"] = [=[--[[
...
files["factory/harness_initialize.lua"] = [=[--[[
...
files["factory/harness_inventory.lua"] = [=[--[[
...
files["factory/harness_logger.lua"] = [[-- Logger harness for lib_logger.lua
...
files["factory/harness_movement.lua"] = [[-- Movement harness for lib_movement.lua
...
files["factory/harness_navigation_steps.lua"] = [[local navigation_steps = {}
...
files["factory/harness_navigation.lua"] = [[-- Navigation harness for lib_navigation.lua
...
files["factory/harness_parser_data.lua"] = [=[local parser_data = {}
...
files["factory/harness_parser.lua"] = [=[--[[
...
files["factory/harness_placement_data.lua"] = [[local placement_data = {}
...
files["factory/harness_placement.lua"] = [=[--[[
...
files["factory/harness_worldstate.lua"] = [=[-- World state harness for lib_worldstate.lua
...
files["factory/state_initialize.lua"] = [=[--[[
State: INITIALIZE
...
files["factory/state_treefarm.lua"] = [=[--[[
State: TREEFARM
...
files["installer.lua"] = [=[-- installer.lua
-- Arcadesys Unified Installer
